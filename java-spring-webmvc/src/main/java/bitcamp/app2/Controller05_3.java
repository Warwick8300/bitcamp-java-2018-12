...
public class Controller05_3 {
  ...
  public Object handler5(@RequestBody Board content) throws Exception {
    ...
    // 주의 !
    // =>클라이언트에서 보낸 날짜 데이터의 문자열 형식이 yyyy-MM-dd 형태여야한다.
    //  그래야 java.util.Date 타입의 값으로 변환해 준다.
    // 예 )2019-05-01 ===> java.til.Date 객체 변환 성공 !
    // => 만약 이혀애가 아니면 변환할 수 없어 실행오류가 발생한다.
    // 예 2019-5-1 ==> 변환오류
    
    //@JsonFormat 애노테이션 사용
    // => 도메인 객체의 프로퍼티에 이 애노테이션을 붙이면 2019-05-01 이나
