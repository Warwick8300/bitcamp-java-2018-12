...
<body>
  ...
  <h1>사진 조회</h1>
  <jsp:useBean id="list" scope="request" type="java.util.List<Lesson>" />
  <jsp:useBean id="files" scope="request" type="java.util.List<PhotoFile>" />
  <jsp:useBean id="board" scope="request" type="com.eomcs.lms.domain.PhotoBoard" />
