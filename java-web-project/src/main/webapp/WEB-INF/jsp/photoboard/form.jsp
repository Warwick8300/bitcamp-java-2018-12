  ...
  <div class="container">
    ...
    <form action='add' method='post' enctype='multipart/form-data'>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="file" class="form-control-plaintext" id="photo" name='photo'>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="file" class="form-control-plaintext" name='photo'>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="file" class="form-control-plaintext" id="photo5" name='photo'>
        </div>
      </div>
